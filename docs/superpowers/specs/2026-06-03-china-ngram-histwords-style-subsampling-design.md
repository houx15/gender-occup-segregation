...
- **PPMI+SVD path.** Not the embedding family we're using; HistWords mentions it as the count-based representation but our SGNS arm is the one being corrected.
